MRuby::Build.new do |conf|
  ...
  # for OSX
  if ENV['MRUBY_CROSS_OS'] == "darwin"
    MRuby::CrossBuild.new('darwin') do |conf|
  ...
  if ENV['MRUBY_CROSS_OS'] == "win64"
    MRuby::CrossBuild.new('win64') do |conf|
  
      toolchain :gcc
  
      url = 'brew info mingw-w64'
      cgcc = "/usr/local/bin/x86_64-w64-mingw32-gcc"
      car = "/usr/local/bin/x86_64-w64-mingw32-ar"
